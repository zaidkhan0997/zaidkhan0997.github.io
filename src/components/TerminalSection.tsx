      ...
      output: (
        <div className="space-y-1 text-emerald-400 font-mono text-xs">
          ...
          <p className="text-white/70">
            Type <span className="text-rose-300 font-bold">&apos;help&apos;</span> to see available commands or <span className="text-rose-300 font-bold">&apos;whoami&apos;</span> for profile details.
          </p>
        </div>
      ),
    },
  ...
  const handleCommand = (e: React.FormEvent) => {
    ...
    switch (trimmed) {
      case 'help':
        outputNode = (
          <div className="space-y-1 text-xs font-mono">
            <p className="text-rose-300 font-bold">Available CLI Commands:</p>
      ...
      case 'whoami':
        outputNode = (
          <div className="space-y-1 text-xs font-mono">
            <p className="text-rose-300 font-bold">MOHD ZAID ( zaidkhan0997 )</p>
      ...
      case 'skills':
        outputNode = (
          <div className="space-y-1 text-xs font-mono">
            <p className="text-rose-300 font-bold">Technical Skills:</p>
      ...
      case 'repos':
        outputNode = (
          <div className="space-y-1 text-xs font-mono">
            <p className="text-rose-300 font-bold">Featured Repositories:</p>
      ...
      case 'contact':
        outputNode = (
          <div className="space-y-1 text-xs font-mono">
            <p className="text-rose-300 font-bold">Connect with MOHD ZAID:</p>
            <p>Email: <a href="mailto:kzaid0997@gmail.com" className="text-rose-300 underline">kzaid0997@gmail.com</a></p>
            <p>Telegram: <a href="https://t.me/zaidkhan0997" target="_blank" rel="noreferrer" className="text-rose-300 underline">t.me/zaidkhan0997</a></p>
            <p>GitHub: <a href="https://github.com/zaidkhan0997" target="_blank" rel="noreferrer" className="text-rose-300 underline">github.com/zaidkhan0997</a></p>
          </div>
        );
        break;
      ...
      case 'stats':
        outputNode = (
          <div className="space-y-1 text-xs font-mono text-rose-300">
            <p className="text-rose-300 font-bold">Analytics Overview:</p>
      ...
      case 'banner':
        outputNode = (
          <pre className="text-[10px] sm:text-xs text-rose-300 font-mono leading-tight">
    ...
    <section id="terminal" className="bg-transparent py-20 border-b border-white/10">
      <div className="mx-auto max-w-7xl px-6 md:px-10">
        ...
        <motion.div
          ...
          className="mx-auto max-w-4xl overflow-hidden rounded-3xl border border-white/20 bg-white/[0.03] backdrop-blur-3xl shadow-[inset_0_1.5px_2px_rgba(255,255,255,0.25),0_20px_50px_rgba(0,0,0,0.5)] hover:border-rose-300/80 transition-all duration-300 ease-out"
        >
          ...
          <div className="flex items-center justify-between border-b border-white/15 bg-white/[0.06] px-5 py-3.5 backdrop-blur-3xl">
            ...
            <div className="flex items-center gap-2 text-xs font-mono font-semibold text-white/80">
              <TerminalIcon className="h-3.5 w-3.5 text-rose-300" />
              ...
              <div key={idx} className="space-y-1.5">
                {item.command !== 'welcome' && (
                  <div className="flex items-center gap-2 text-xs text-white/80">
                    <span className="text-rose-300 font-bold">mohdzaid@device-tree:~$</span>
          ...
          <form onSubmit={handleCommand} className="border-t border-white/15 bg-white/[0.04] px-5 py-3.5 backdrop-blur-3xl">
            <div className="flex items-center gap-2.5">
              <span className="text-xs font-mono font-bold text-rose-300">mohdzaid@device-tree:~$</span>
              <input
                type="text"
                value={input}
              ...
              />
              <button type="submit" className="text-white/60 hover:text-rose-300 transition-colors">
