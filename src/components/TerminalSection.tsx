...
const renderNeofetch = () => (
  <div className="space-y-1 text-xs font-mono">
    ...
    <p className="text-white/60">
      Type <span className="text-cyan-400 font-bold">&apos;help&apos;</span> to see available commands or <span className="text-cyan-400 font-bold">&apos;whoami&apos;</span> for profile details.
    </p>
  </div>
);
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 md:px-10">
        ...
        >
          ...
          <div className="grid grid-cols-3 items-center px-4 sm:px-5 py-3.5 border-b border-white/10 bg-white/[0.02] shrink-0">
            ...
            <div className="flex items-center justify-end gap-1 text-xs font-mono text-cyan-300/90">
          ...
          >
            ...
            <form onSubmit={handleCommand} className="flex items-center gap-2 pt-4 shrink-0">
              <span className="text-cyan-400 font-bold shrink-0">zaidkhan0997@dev:~$</span>
              <input
                ref={inputRef}
                type="text"
                value={input}
