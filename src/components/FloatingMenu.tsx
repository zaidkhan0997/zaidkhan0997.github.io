          ...
          <>
            ...
            >
              ...
              <div className="flex items-center justify-between rounded-full frosted-glass-pill p-2.5 sm:p-3 mb-4">
                <div className="flex items-center gap-3 min-w-0 pl-1">
                  <div className="relative shrink-0">
                    <img
                      ...
                      alt="MOHD ZAID"
                      className="h-10 w-10 sm:h-11 sm:w-11 rounded-full object-cover border border-cyan-400/40 shadow-md"
                    />
                    <span className="absolute -bottom-0.5 -right-0.5 h-2.5 w-2.5 sm:h-3 sm:w-3 rounded-full bg-cyan-400 shadow-[0_0_8px_rgba(6,182,212,0.8)] ring-2 ring-black" />
                  </div>
                ...
                <button
                  onClick={() => setIsOpen(false)}
                  className="flex h-9 w-9 sm:h-10 sm:w-10 items-center justify-center rounded-full frosted-glass-pill text-white/80 hover:border-cyan-300 hover:bg-gradient-to-r hover:from-violet-600 hover:to-cyan-500 hover:text-white hover:scale-105 transition-all shrink-0 shadow-md"
              ...
              <div className="rounded-3xl frosted-glass-card p-3.5 sm:p-4 mb-4 space-y-3">
                <div className="flex items-center gap-1.5 text-[10px] font-bold tracking-widest text-cyan-300 uppercase pl-1">
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-center gap-2.5 min-w-0">
                          <div className="flex h-9 w-9 items-center justify-center rounded-2xl border border-cyan-400/40 bg-white/[0.08] text-cyan-300 group-hover:bg-gradient-to-r group-hover:from-violet-600 group-hover:to-cyan-500 group-hover:text-white transition-colors shrink-0">
                        ...
                        <ChevronRight className="h-4 w-4 text-white/40 group-hover:text-cyan-300 group-hover:translate-x-1 transition-all shrink-0 mr-1.5" />
                      </motion.a>
                    );
                  })}
                </div>
              ...
              <div className="rounded-3xl frosted-glass-card p-3.5 sm:p-4 mb-4 space-y-3">
                ...
                <div className="flex flex-wrap gap-2 text-[11px]">
                  <a
                    href="#skills"
                    onClick={() => setIsOpen(false)}
                    className="flex items-center gap-1.5 rounded-full frosted-glass-pill px-3 py-1.5 font-medium text-white/90 hover:border-cyan-400 hover:text-cyan-300 transition-colors"
                  >
              ...
              <div className="rounded-3xl frosted-glass-card p-3.5 sm:p-4 space-y-3">
                <div className="grid grid-cols-2 gap-2.5">
                  <div className="flex items-center justify-center gap-2 rounded-full frosted-glass-pill py-2.5 px-3 text-cyan-300 font-bold font-mono text-xs" title="Total Views">
                  ...
                  <button
                    ...
                    className={`flex items-center justify-center gap-2 rounded-full frosted-glass-pill py-2.5 px-3 font-bold font-mono text-xs transition-all active:scale-95 ${
                      hasLiked
                        ? 'border-cyan-400 bg-gradient-to-r from-violet-600 to-cyan-500 text-white shadow-[0_0_15px_rgba(6,182,212,0.5)]'
                        : 'text-cyan-300 hover:bg-cyan-500/20'
                    }`}
                    title={hasLiked ? 'Liked!' : 'Click to Like'}
                  >
                    <Heart className={`h-3.5 w-3.5 ${hasLiked ? 'fill-current text-white' : 'fill-cyan-400/20 text-cyan-300'}`} />
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="flex w-full items-center justify-center gap-2 rounded-full bg-gradient-to-r from-violet-600 to-cyan-500 py-3 text-xs font-bold text-white shadow-[0_0_15px_rgba(6,182,212,0.4)] transition-transform hover:scale-[1.01] active:scale-[0.99]"
                >
