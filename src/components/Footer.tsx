            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-6">
              ...
              <div className="flex items-center space-x-3 rounded-full border border-white/20 bg-white/[0.03] p-2.5 sm:p-3 backdrop-blur-md shadow-md">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="flex h-10 w-10 sm:h-11 sm:w-11 items-center justify-center rounded-full border border-white/15 bg-white/[0.06] text-white/90 hover:border-cyan-300 hover:bg-gradient-to-r hover:from-violet-600 hover:to-cyan-500 hover:text-white transition-all hover:scale-110 shadow-sm"
                  title="GitHub"
                >
              ...
              <button
                onClick={scrollToTop}
                className="flex items-center space-x-2 rounded-full border border-white/15 bg-white/[0.06] px-4 py-2 text-white/80 hover:border-cyan-300 hover:bg-gradient-to-r hover:from-violet-600 hover:to-cyan-500 hover:text-white transition-all hover:scale-105 shadow-sm"
              >
