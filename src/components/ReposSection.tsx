      ...
      <div>
        <div className="flex items-center justify-between mb-3.5">
          <div className="flex items-center gap-2.5 min-w-0 flex-1">
            <div className="flex h-8.5 w-8.5 sm:h-9 sm:w-9 items-center justify-center rounded-2xl border border-cyan-400/40 bg-white/[0.08] text-cyan-300 backdrop-blur-md group-hover:bg-gradient-to-r group-hover:from-violet-600 group-hover:to-cyan-500 group-hover:text-white transition-colors shadow-sm shrink-0">
  ...
  return (
    <section id="projects" className="bg-transparent py-20 border-b border-white/10 overflow-hidden">
      <div className="mx-auto max-w-7xl px-6 md:px-10">
        ...
        >
          <div className="inline-flex items-center gap-2 rounded-full bg-cyan-500/15 px-3.5 py-1 text-xs font-semibold text-cyan-300 border border-cyan-400/40 backdrop-blur-3xl shadow-[inset_0_1px_1px_rgba(255,255,255,0.3)]">
            <span className={`h-2 w-2 rounded-full ${isLive ? 'bg-cyan-400 animate-pulse shadow-[0_0_8px_rgba(6,182,212,0.8)]' : 'bg-cyan-500'}`} />
        ...
        >
          <div className="flex flex-wrap items-center gap-2">
            ...
            <button
              ...
              className="p-2 rounded-2xl frosted-glass-pill text-white/80 hover:text-cyan-300 transition-colors"
            >
          ...
          <div className="relative w-full md:w-72">
            ...
            <input
              ...
              className="w-full rounded-2xl frosted-glass-pill pl-10 pr-4 py-2.5 text-xs text-white placeholder:text-white/40 focus:outline-none focus:ring-2 focus:ring-cyan-400 resize-none"
            />
          </div>
        </motion.div>
