...
const SkillCard3D = ({ skill, index }: { skill: SkillItem; index: number }) => {
  ...
  return (
    <motion.div
      ...
      className="group rounded-3xl border border-white/20 bg-white/[0.03] p-6 backdrop-blur-3xl shadow-[inset_0_1.5px_2px_rgba(255,255,255,0.25),0_12px_32px_rgba(0,0,0,0.35)] hover:border-cyan-300/80 hover:bg-white/[0.09] hover:shadow-[0_0_35px_rgba(6,182,212,0.4)] transition-all duration-300 ease-out"
    >
      ...
      <div className="h-2 w-full rounded-full bg-white/15 overflow-hidden shadow-inner">
        <motion.div
          ...
          className="h-full rounded-full bg-cyan-400 shadow-md"
        />
      </div>
    </motion.div>
  );
  ...
  return (
    <section id="skills" className="bg-transparent py-20 border-b border-white/10 overflow-hidden">
      <div className="mx-auto max-w-7xl px-6 md:px-10">
        ...
        >
          <span className="inline-block rounded-full bg-cyan-400/20 px-3.5 py-1 text-xs font-semibold text-cyan-300 border border-cyan-400/40 backdrop-blur-3xl shadow-[inset_0_1px_1px_rgba(255,255,255,0.3)]">
            TECHNICAL MASTERY
          </span>
