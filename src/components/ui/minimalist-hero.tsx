...
const SocialIcon = ({ href, icon: Icon }: { href: string; icon: LucideIcon }) => (
  <a
    ...
    className="flex h-8 w-8 sm:h-10 sm:w-10 lg:h-11 lg:w-11 items-center justify-center rounded-full frosted-glass-pill text-white/90 transition-all hover:border-cyan-300 hover:bg-gradient-to-r hover:from-violet-600 hover:to-cyan-500 hover:text-white hover:scale-110 shadow-md shrink-0 p-0 leading-none"
  >
      ...
      <div className="fixed top-2.5 sm:top-4 left-0 right-0 z-[60] px-3 sm:px-6 flex justify-center pointer-events-none">
        ...
        >
          ...
          >
            <div className="flex items-center gap-2 sm:gap-2.5 text-sm sm:text-base md:text-lg font-bold tracking-wider text-white min-w-0">
              <div className="relative shrink-0">
                <img
                  ...
                  alt="MOHD ZAID"
                  className={cn(
                    'rounded-full object-cover border border-cyan-400/40 shadow-md transition-all duration-300',
                    isScrolled ? 'h-7 w-7 sm:h-8 sm:w-8' : 'h-8 w-8 sm:h-9 sm:w-9'
                  )}
                />
                <span className="absolute -bottom-0.5 -right-0.5 h-2 w-2 sm:h-2.5 sm:w-2.5 rounded-full bg-cyan-400 shadow-[0_0_8px_rgba(6,182,212,0.8)] ring-2 ring-black" />
              </div>
              ...
              <span
                className={cn(
                  'rounded-full border border-cyan-400/30 bg-white/[0.08] px-2.5 py-0.5 text-[10px] font-mono font-medium text-cyan-300 transition-all duration-300',
            ...
            <div className="hidden lg:flex items-center gap-3 shrink-0">
              <a
                ...
                rel="noopener noreferrer"
                className={cn(
                  'inline-flex items-center gap-1.5 rounded-full frosted-glass-pill text-cyan-300 font-semibold transition-all hover:bg-gradient-to-r hover:from-violet-600 hover:to-cyan-500 hover:text-white hover:scale-105 shadow-sm font-ubuntu',
          ...
          <button
            onClick={triggerMenu}
            className={cn(
              'shrink-0 flex items-center justify-center rounded-3xl frosted-glass-card text-cyan-300 transition-all duration-300 ease-out hover:border-cyan-400/80 hover:bg-gradient-to-r hover:from-violet-600 hover:to-cyan-500 hover:text-white hover:scale-105 focus:outline-none',
      ...
      <div className="relative grid w-full max-w-7xl flex-grow grid-cols-1 items-center gap-4 sm:gap-6 lg:gap-8 py-3 sm:py-6 lg:grid-cols-3">
        ...
        >
          <HeroCard3D className="space-y-4 sm:space-y-5 text-left w-full !p-6 sm:!p-7">
            {/* Top Badge Pill */}
            <div>
              <div className="inline-flex items-center gap-2.5 rounded-full frosted-glass-pill px-4 py-1.5 text-xs font-semibold text-cyan-300 font-ubuntu tracking-wide">
            ...
            <div className="space-y-1.5">
              <h3 className="text-sm sm:text-base font-bold text-cyan-300 leading-snug font-ubuntu">
              ...
              <div>
                <div className="inline-flex items-center rounded-full frosted-glass-pill px-4 py-2">
                  <span className="text-xs font-normal text-white/80 font-ubuntu italic">
                    &quot;Be happy, <span className="text-cyan-300 font-bold not-italic">it drives people crazy.</span>&quot;
                  </span>
                </div>
              </div>
            )}
            ...
            <div className="pt-1">
              <a
                href="#skills"
                className="inline-flex items-center gap-1.5 text-xs sm:text-sm font-semibold text-cyan-300 underline decoration-cyan-400 decoration-2 underline-offset-8 transition-all hover:text-cyan-200 font-ubuntu"
              >
        ...
        >
          ...
          <HeroCard3D className="flex flex-col items-center justify-center text-center lg:items-start lg:text-left w-full min-w-0">
            <h1 className="text-xl font-black tracking-widest text-white sm:text-3xl md:text-3xl lg:text-4xl xl:text-5xl leading-tight select-none uppercase font-display">
              {overlayText.part1}{' '}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-violet-400 via-cyan-300 to-cyan-400 font-black drop-shadow-[0_0_14px_rgba(6,182,212,0.8)]">
                {overlayText.part2}
              </span>
            </h1>
